...
#### `docs/iptables-split-tunnel.md` (Clean & Professional)

```markdown
# iptables Split Tunneling for SSH & VNC (Persistent)

**Purpose**: Bypass the PIA VPN for ports **22 (SSH)** and **5900 (VNC)** while keeping all other traffic routed through the VPN.

---

## 1. Mark Traffic for Bypass
